...
./run_build.sh boki-local $CONTROLLER_SPEC_DIR/boki/eng4-st4-seq3-ir4-ur1-mr3.json $BASE_DIR/specs/exp-cf12.json
...
$HELPER_SCRIPT start-machines --base-dir=$BASE_DIR
./run_build.sh boki-remote $CONTROLLER_SPEC_DIR/boki/eng4-ei2-st4-seq3-ir2-ur1-mr3.json $BASE_DIR/specs/exp-cf1.json
./run_build.sh boki-remote $CONTROLLER_SPEC_DIR/boki/eng4-ei2-st4-seq3-ir2-ur1-mr3.json $BASE_DIR/specs/exp-cf2.json
./run_build.sh boki-remote $CONTROLLER_SPEC_DIR/boki/eng4-ei2-st4-seq3-ir2-ur1-mr3.json $BASE_DIR/specs/exp-cf4.json
./run_build.sh boki-remote $CONTROLLER_SPEC_DIR/boki/eng4-ei2-st4-seq3-ir2-ur1-mr3.json $BASE_DIR/specs/exp-cf8.json
./run_build.sh boki-remote $CONTROLLER_SPEC_DIR/boki/eng4-ei2-st4-seq3-ir2-ur1-mr3.json $BASE_DIR/specs/exp-cf12.json
./run_build.sh boki-remote $CONTROLLER_SPEC_DIR/boki/eng4-ei2-st4-seq3-ir2-ur1-mr3.json $BASE_DIR/specs/exp-cf15.json
...
cp $MACHINE_SPEC_DIR/indilog/machines_eng4-st4-seq3-ix2-agg1.json $BASE_DIR/machines.json
$HELPER_SCRIPT start-machines --base-dir=$BASE_DIR
./run_build.sh indilog-remote $CONTROLLER_SPEC_DIR/indilog/eng4-st4-seq3-ix2-agg1-is2-ir1-ur1-mr3-ssmx4.json $BASE_DIR/specs/exp-cf1.json
./run_build.sh indilog-remote $CONTROLLER_SPEC_DIR/indilog/eng4-st4-seq3-ix2-agg1-is2-ir1-ur1-mr3-ssmx4.json $BASE_DIR/specs/exp-cf2.json
./run_build.sh indilog-remote $CONTROLLER_SPEC_DIR/indilog/eng4-st4-seq3-ix2-agg1-is2-ir1-ur1-mr3-ssmx4.json $BASE_DIR/specs/exp-cf4.json
./run_build.sh indilog-remote $CONTROLLER_SPEC_DIR/indilog/eng4-st4-seq3-ix2-agg1-is2-ir1-ur1-mr3-ssmx4.json $BASE_DIR/specs/exp-cf8.json
./run_build.sh indilog-remote $CONTROLLER_SPEC_DIR/indilog/eng4-st4-seq3-ix2-agg1-is2-ir1-ur1-mr3-ssmx4.json $BASE_DIR/specs/exp-cf12.json
./run_build.sh indilog-remote $CONTROLLER_SPEC_DIR/indilog/eng4-st4-seq3-ix2-agg1-is2-ir1-ur1-mr3-ssmx4.json $BASE_DIR/specs/exp-cf15.json

# Benchmark collected csv file
for FILE_TYPE in "pdf" "png";
do
    $BENCHMARK_SCRIPT generate-plot-indilog-vs-indilog-min-seqnum-completion-append --file=$RESULT_DIR/throughput-vs-latency.csv --result-file=$RESULT_DIR/throughput-vs-latency-indilog-vs-indilog-min-append.$FILE_TYPE
    $BENCHMARK_SCRIPT generate-plot-indilog-vs-indilog-min-seqnum-completion-read --file=$RESULT_DIR/throughput-vs-latency.csv --result-file=$RESULT_DIR/throughput-vs-latency-indilog-vs-indilog-min-read.$FILE_TYPE
    $BENCHMARK_SCRIPT generate-plot-boki-vs-indilog-append --file=$RESULT_DIR/throughput-vs-latency.csv --result-file=$RESULT_DIR/throughput-vs-latency-boki-vs-indilog-append-local.$FILE_TYPE
    $BENCHMARK_SCRIPT generate-plot-boki-vs-indilog-read --file=$RESULT_DIR/throughput-vs-latency.csv --result-file=$RESULT_DIR/throughput-vs-latency-boki-vs-indilog-read-local.$FILE_TYPE
    $BENCHMARK_SCRIPT generate-plot-boki-remote-vs-indilog-remote-read --file=$RESULT_DIR/throughput-vs-latency.csv --result-file=$RESULT_DIR/throughput-vs-latency-boki-vs-indilog-read-remote.$FILE_TYPE
done
