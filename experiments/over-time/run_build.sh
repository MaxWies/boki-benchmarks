...
$CONFIG_MAKER_SCRIPT generate-runtime-config --base-dir=$BASE_DIR --slog=$SLOG --controller-spec-file=$CONTORLLER_SPEC_FILE --exp-spec-file=$EXP_SPEC_FILE
