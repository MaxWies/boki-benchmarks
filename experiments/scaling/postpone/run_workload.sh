...
# $HELPER_SCRIPT start-machines --base-dir=$BASE_DIR
./run_build.sh indilog-postpone-caching $CONTROLLER_SPEC_DIR/indilog/eng4-st4-seq3-ix2-m1-is2-ir1-ur1-mr3-ssmx4.json $BASE_DIR/specs/exp-cf15.json
...
# $HELPER_SCRIPT start-machines --base-dir=$BASE_DIR
# ./run_build.sh indilog-postpone-registering $CONTROLLER_SPEC_DIR/indilog/eng3-st3-seq3-ix2-is2-ir1-ur1-mr3-ssmx4.json $BASE_DIR/specs/exp-cf15.json
