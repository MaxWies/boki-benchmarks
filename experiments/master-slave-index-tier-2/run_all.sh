...
# ./run_build.sh indilog 2-1-1-true $CONTROLLER_SPEC_DIR/indilog/eng4-st4-seq3-ix2-agg1-is2-ir1-ur1-mr3-ssmx4.json $BASE_DIR/specs/exp-cf4-point-hit.json
# ./run_build.sh indilog 2-1-1-false $CONTROLLER_SPEC_DIR/indilog/eng4-st4-seq3-ix2-agg1-is2-ir1-ur1-mr3-ssmx4.json $BASE_DIR/specs/exp-cf4-point-miss.json
...
$HELPER_SCRIPT start-machines --base-dir=$BASE_DIR
./run_build.sh boki-remote 1-2-0-boki $CONTROLLER_SPEC_DIR/boki/eng4-ei2-st4-seq3-ir2-ur1-mr3.json $BASE_DIR/specs/exp-cf4-point-hit.json
