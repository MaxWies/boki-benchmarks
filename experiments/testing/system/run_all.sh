...
# $HELPER_SCRIPT start-machines --base-dir=$BASE_DIR
# ./run_build.sh indilog-index-tier-only $CONTROLLER_SPEC_DIR/indilog/eng4-st4-seq3-ix6-m1-is6-ir1-ur1-mr3-ssmx4.json $BASE_DIR/specs/exp-cf24.json

cp $MACHINE_SPEC_DIR/indilog/machines_eng4-st4-seq3-ix6-m1.json $BASE_DIR/machines.json
$HELPER_SCRIPT start-machines --base-dir=$BASE_DIR
./run_build.sh indilog-index-tier-only $CONTROLLER_SPEC_DIR/indilog/eng4-st4-seq3-ix6-m1-is2-ir3-ur1-mr3-ssmx4.json $BASE_DIR/specs/exp-cf24.json