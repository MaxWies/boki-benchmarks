...
$BENCHMARK_SCRIPT generate-plot --file=$RESULT_DIR/concurrency-vs-latency.csv --slog=boki-local-local --result-file=$RESULT_DIR/concurrency-vs-latency_local-locall.pdf
$BENCHMARK_SCRIPT generate-plot --file=$RESULT_DIR/concurrency-vs-latency.csv --slog=boki-hybrid-hybrid --result-file=$RESULT_DIR/concurrency-vs-latency_hybrid-hybrid.pdf
$BENCHMARK_SCRIPT generate-plot --file=$RESULT_DIR/concurrency-vs-latency.csv --slog=boki-remote-local --result-file=$RESULT_DIR/concurrency-vs-latency_remote-local.pdf
$BENCHMARK_SCRIPT generate-plot --file=$RESULT_DIR/concurrency-vs-latency.csv --slog=boki-hybrid-local --result-file=$RESULT_DIR/concurrency-vs-latency_hybrid-local.pdf
